...
class Cliques(BaseApi):
    async def get_cliques(self) -> List[str]:
    ...
    async def get_clique(self, clique_name):
    ...
    async def create_clique(self, clique_name: str):
    ...
    async def rename_clique(self, clique_name: str, new_name: str):
        r"""Rename a clique.
        """
    ...
    async def add(self, clique_name: str, user_id: int):
    ...
    async def remove(self, clique_name: str, user_id: int):
        r"""Add a user to the clique.
        """
